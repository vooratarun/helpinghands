...
<title>HH : DrawBox</title>
	...
	<script type="text/javascript">
		...
		{
			var evnt = $("#contributor").val();
			var amnt = $("#amount").val();
			$.post("./contribution/contribution_admin_2.php",{contributor:evnt,amount:amnt},function(text)
			{
				$("#div_cont").html(text);
			});
			$("#cont_d").hide();
    ...
    <div style="background:#ffffff;">
		...
		<div id="cont_d">
			<table id="customers" >
				<tr>
					<th>Contributor</th>
					<th><input type="text" id="contributor" placeholder="Name of Contributor"/></th>
				</tr>
				<tr>
					<td>Enter Amount</td>
