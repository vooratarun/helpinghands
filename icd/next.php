...
s1;
   ...
   -moz-border-radius: 5px;">ICD Details</h1>
...
<div id="main_body">
	...
	<table  style="margin:2% 12%;" width=75%;>
		<tr><td style="font-size:20px;font-weight:bold;color:orange;cursor:pointer;width:200px;height:55px" id="c3" onclick="show_details_categ(this.id)">Internal Care Department</td><td rowspan=7 align=center><img src="images/logo.png" id="imgs" style="width:350px;height:300px;display:block;" />
...
<!--
		...
		<tr><td style="font-size:20px;font-weight:bold;color:green;cursor:pointer;width:200px;height:55px" id="c5" onclick="show_details_categ(this.id)">3.Public Relations Department</td>--><tr><td></td></tr><tr><td></td></tr><tr><td></td><td rowspan=3 align=center id="tdd">To sanction</br>Money</br><center><a href="student.php" style="text-decoration:none;"><input type=button value="Click Here" id="Btn"></a></td></tr><!--
