...
<?php
		...
		?>
<body onLoad="load_home();doTimer();" ><br>
		...
		<tr>
			<td align="center">
				<div id="help" >
					...
					<div id="menu" style="background-color:#0080C0;/*#0E9EC7;#3333B3;*/;text-shadow:0px;width:1006px;align:center; " >
                		<ul class="menu" style="margin-left:0%;">
                    		...
                    		<li><a href="#" class="parent" ><span>Finance</span></a>
                                ...
                                <li><a href="#" class="parent"><span>Credit</span></a>
                                    <div class="column">
                                        <ul class="two">
                                            <li><a href="#" onClick="load('./wc/load_index.php')"><span>Weekly Money Collection Details</span></a></li>
                                            <li><a href="#" onClick="load('./dropbox/dropbox.php')"><span>Collections from Drop Boxes</span></a></li>
                                            <li><a href="#" onClick="load('./contribution/contribution.php')"><span>Contributions to HH</span></a></li>
                                            <li><a href="#" onClick="load('./books/books.php')"><span>Rough books & News Papers Money</span></a></li>
                                            <li><a href="#" onClick="load('./total/show_total.php')"><span>Total</span></a></li>
                                        </ul>
                                    </div>
                                </li>
                                <li><a href="#" class="parent"><span>Debit</span></a>
									<div class="column">
                                        <ul class="two">
                                            <li><a href="#" onClick="load('./details/')"><span>Debit</span></a></li>
                                            <li><a href="#" onClick="load('./details/prev_details.php')"><span>2013-14</span></a></li>
                                        </ul>
                                    </div>
                                </li>
                            </ul>
                    ...
                    <li><a href="#" onClick="load('./Gallery/load_gallery.php')"><span>Gallery</span></a></li>
                    <li><a href="#" onClick="load('hand_index.php')"><span>I Need Help</span></a></li>
                    <li><a href="#" onClick="load('./faq/')"><span>FAQ'S</span></a></li>
                    <li><a href="#" onClick="load('./gratitude/load_index.php')"><span>Gratitude</span></a></li>
                    <li><a href="#" onClick="load('./Note-/notify.php')"><span>Notifications
                    <?php 
                    if($new_status>0)
                    {
                    ...
                    <li><a href="#" onClick="load('./contact/contact.php')"><span>Contact Us</span></a></li>


                </ul>
            </div>
<div id="maindiv" style="z-index: 1;"></div>
</div></table>
