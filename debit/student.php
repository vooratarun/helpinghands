...

{
	...
	{
		document.getElementById("ed_error").innerHTML="Reason field is empty";
		document.getElementById("ed_error").style.display="block";
		return false;
	}
	else
	...
	<div id="editp">
		...
		<div id="edit_body">
			...
			<form action="filled_form.php" method=post>
				...
				<tr>
					<td><b>Reason </b></td><td><textarea rows=4 cols=35 id="reason" name="reason"></textarea></td>
				</tr>
				<tr>
					<td  align=left>
					<b></b></td>
		...
		<div style="top:400px;"id="edit_footer"><input type=submit value=Submit id=edit_but name="ed_sub" onclick="return valid_edit()">&nbsp;&nbsp;<input type=button value=Cancel id=edit_cancel onclick="close_w()"></div>
			</form>
			<div id="ed_error"></div>
	</div>
