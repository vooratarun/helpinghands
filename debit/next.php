...
?>
	...
	<script type=text/javascript>
		function show_details_categ(id)
		{
			...
			{
				<?php
					$qu=mysql_query("select * from details where year='$ye' and cate_name='hcd'");
					$data=mysql_fetch_array($qu);
					echo <<<s1
							document.getElementById("categ_disp").innerHTML="HCD";
							...
							document.getElementById('categ').value="HCD";
s1;
				?>
			}
			else if(id=="c2")
...
s1;
			...
			{
				<?php
					$qu=mysql_query("select * from details where year='$ye' and cate_name='icd'");
					$data=mysql_fetch_array($qu);
					echo <<<s1
							document.getElementById("categ_disp").innerHTML="ICD";
							document.getElementById("ast").style.display="block";
							document.getElementById("imgs").style.display="none";
							document.getElementById('tot_all').innerHTML="<td>: Rs "+'$data[3]'+"/-</td>";
							document.getElementById('spent_mon').innerHTML="<td>: Rs "+'$data[4]'+"/-</td>";
							document.getElementById('remain_mon').innerHTML="<td>: Rs "+'$data[5]'+"/-</td>";
							document.getElementById('categ').value="ICD";
s1;
				?>
			}
			else if(id=="c4")
...
s1;
			...
			{
				<?php
					$qu=mysql_query("select * from details where year='$ye' and cate_name='prd'");
					$data=mysql_fetch_array($qu);
					echo <<<s1
							document.getElementById("categ_disp").innerHTML="PRD";
							document.getElementById("imgs").style.display="none";
							document.getElementById("ast").style.display="block";
							document.getElementById('tot_all').innerHTML="<td>: Rs "+'$data[3]'+"/-</td>";
							document.getElementById('spent_mon').innerHTML="<td>: Rs "+'$data[4]'+"/-</td>";
							document.getElementById('remain_mon').innerHTML="<td>: Rs "+'$data[5]'+"/-</td>";
							document.getElementById('categ').value="PRD";
s1;
				?>
			}
			else if(id=="c6")
...
s1;
			...
			{
				<?php
					$qu=mysql_query("select * from details where year='$ye' and cate_name='fd'");
					$data=mysql_fetch_array($qu);
					echo <<<s1
							document.getElementById("categ_disp").innerHTML="FD";
							document.getElementById("imgs").style.display="none";
							document.getElementById("ast").style.display="block";
							document.getElementById('tot_all').innerHTML="<td>: Rs "+'$data[3]'+"/-</td>";
							document.getElementById('spent_mon').innerHTML="<td>: Rs "+'$data[4]'+"/-</td>";
							document.getElementById('remain_mon').innerHTML="<td>: Rs "+'$data[5]'+"/-</td>";
							document.getElementById('categ').value="FD";
s1;
				?>
			} 
		}
...
<div id="main_body">
	...
	<table  style="margin:2% 12%;" width=75%;>
		<tr><td  style="font-size:20px;font-weight:bold;color:green;cursor:pointer;width:200px;height:55px" id="c1" onclick="show_details_categ(this.id)">1.Health Care Department</td><td rowspan=7 align=center><img src="images/logo.png" id="imgs" style="width:350px;height:300px;display:block;" />
		...
		<tr><td style="font-size:20px;font-weight:bold;color:green;cursor:pointer;width:200px;height:55px" id="c5" onclick="show_details_categ(this.id)">3.Public Relations Department</td><td rowspan=3 align=center id="tdd">To sanction</br>Money</br><center><a href="student.php" style="text-decoration:none;"><input type=button value="Click Here" id="Btn"></a></td></tr>
