   ...
   -moz-border-radius: 5px;">Debit Details</h1>
    ...
    <div id="main_body">
		...
		<table align=center id="det_table">
			...
			<tr><td>Reason</td><td>: <?php echo $res; ?></td></tr>
		...
		<div style="display:none">
			...
			<input type=text value=<?php echo $res; ?> name="reason" />
		</div>
			</form>
		</table>
...
s;
			$batch="20".$bat;
$co=mysql_query("insert into students values('$ye','$id1','$dat','$cat','$amt','$res','$fname','$batch')");
