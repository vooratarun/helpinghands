  ...
  <body>
      <div class="main">
          ...
          <table id="regtable">
              ...
              <tr>
                   <td align="left" width="30%">ID NO:</td><td>  <input type="text" class="input-block-level" name="idno" id="idno" value="$idno" size="7"     </td>
              </tr>
              <tr>
               ...
               <tr>
                  <td align="left">Gender : </td><td><select style="width:100px;" class="input-block-level" name="gender" id="gender"><option value="">choose</option><option value='M'>Male</option><option value='F'>Female</option></td>
              </tr>
