...
<?php
	...
	$categor_money[0]=$engg_4;$categor_money[1]=$engg_3;$categor_money[2]=$engg_2;$categor_money[3]=$engg_1;$categor_money[4]=$puc_2;$categor_money[5]=$puc_1;$categor_money[6]=$total_money;
	for($i=0;$i<7;$i++)
	{
	...
	$strXML .= "</graph>";
	echo renderChartHTML("./wc/FCF_Column3D.swf", "", $strXML, "myNext", 800, 450);
?>
            </td>
        </tr>
        <tr>
