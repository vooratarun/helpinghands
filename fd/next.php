...
s1;
   ...
   -moz-border-radius: 5px;">FD Details</h1>
...
<div id="main_body">
	...
	<table  style="margin:2% 12%;" width=75%;>
		<tr><td  style="font-size:20px;font-weight:bold;color:green;cursor:pointer;width:200px;height:55px" id="c7" onclick="show_details_categ(this.id)">Finance Department</td><td rowspan=7 align=center><img src="images/logo.png" id="imgs" style="width:350px;height:300px;display:block;" />
