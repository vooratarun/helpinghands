 ...
 left:35%;
  ...
  <body>
      <div class="main">
          ...
          <table id="regtable">
              <form class="form-signin" action="register_blood.php" method="post">

              <tr>
                   <td align="left" width="30%">ID NO:</td><td width="70%">  <input type="text" class="input-block-level" name="idno" id="idno" value="$idno">    </td>
              </tr>
              <tr>
                    <td align="left">Name :</td><td><input type="text" class="input-block-level" name="name" id="name" value="$name"></td>
              </tr>
              <tr>
                  <td align="left">Gender :</td><td><input type="text" class="input-block-level" name="gender" id="gender" value="$gender"></td>
              </tr>
              <tr>
                  <td align="left">Class :</td><td><input type="text" class="input-block-level" name="class" id="class" value="$class"></td>
              </tr>
               <tr>
                  <td align="left">Batch : </td><td><input type="text" class="input-block-level" name="batch" id="batch" value="$batch"></td>
              </tr>
              <tr>
                  <td align="left">Branch :</td><td><input type="text" class="input-block-level" name="branch" id="branch" value="$branch"></td>
              </tr>
              <tr>
              ...
              <tr>
                  <td colspan="2">Are you willing to donate blood???&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" name="willing" id="wilyes" checked>  Yes&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" name="willing" id="wilno">  No </td>
              </tr>
              <tr>
