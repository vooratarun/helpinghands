...
<title>HH : DrawBox</title>
	...
	<script type="text/javascript">
		function load_next_books()
		{
			...
			var amnt = $("#amount").val();
			var parst =$("#part").val();
			$.post("./books_admin_2.php",{part:parst,crweek:evnt,amount:amnt},function(text)
			{
				$("#div_cont").html(text);
			});
			$("#cont_d").hide();
...
<h3 align="center"><strong>Till Today Money is:</strong>
	...
	$mc=mysql_query("SELECT money FROM roughbooks");
	$amount=0;
		...
		<div id="cont_d">
			<table id="customers" >
				<tr>
					...
					<th><textarea cols=30 rows=5 type="text" id="part" placeholder=""/></th>
				</tr>
				<tr>
					<td> Enter Date</td>
