...
--
-- Host: localhost
-- Generation Time: Sep 08, 2014 at 06:27 PM
...
INSERT INTO `contribution` (`part`, `contributor`, `date`, `money`) VALUES
...
INSERT INTO `dropbox` (`part`, `date`, `money`) VALUES
('', 'FirstTime', 5211),
('', 'SecondTime', 3847),
('', '29-01-2014', 2642);
...
INSERT INTO `roughbooks` (`part`, `date`, `money`) VALUES
('', '11-05-2011', 202000),
('', '05-05-2012', 82699),
('', '20-10-2012', 30975),
(' my name is tarun', ' 11-SEP-2014', 3446),
(' my name is tarun', ' 11-SEP-2014', 3446),
(' my name is tarun', ' 11-SEP-2014', 3446),
(' lsdfkl', ' 03-SEP-2014', 345),
(' lsdfkl', ' 03-SEP-2014', 345),
(' lsdfkl', ' 03-SEP-2014', 345),
(' lsdfkl', ' 03-SEP-2014', 345),
(' lsdfkl', ' 03-SEP-2014', 345),
...
(' lksdjfl', ' 03-SEP-2014', 34),
(' lksdjfl', ' 03-SEP-2014', 34),
(' my name is tar', ' 04-SEP-2014', 345);
