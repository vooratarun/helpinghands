...
<div id="main_body">
	...
	<table  style="margin:2% 12%;" width=75%;>
		<tr><br><td  style="font-size:20px;font-weight:bold;color:green;cursor:pointer;width:200px;height:55px" id="c1" onclick="show_details_categ(this.id)">Health Care Department</td><td rowspan=7 align=center><img src="images/logo.png" id="imgs" style="width:350px;height:300px;display:block;" />
		...
		<tr><td   style="font-size:20px;font-weight:bold;color:orange;cursor:pointers;width:240px;height:55px" id="c2" onclick="kshow_details_categ(this.id)"><!----></td>
		...
		<tr><td style="font-size:20px;font-weight:bold;color:orange;cursor:pointer;width:200px;height:55px" id="c3" onclick="show_details_categ(this.id)">
<!--
2.Internal Care Department</td></tr>
		...
		<tr><td style="font-size:20px;font-weight:bold;color:green;cursor:pointer;width:200px;height:55px" id="c5" onclick="show_details_categ(this.id)">3.Public Relations Department</td>--><tr><td></td></tr><tr><td></td></tr><tr><td></td><tr><td rowspan=3 align=center id="tdd">To sanction</br>Money</br><center><a href="student.php" style="text-decoration:none;"><input type=button value="Click Here" id="Btn"></a></td></tr><!--
