...
<title>Off Records Details</title>
   <style type="text/css">
      #header h1 {
        float: left;
        margin-left: 60px;
		...
		echo <<<s
			<br><div id='rec$rec[0]' class="records">
				<table width=100%>
					...
					<tr><td width=10%>&nbsp;</td><td width=20% class="field_head">Batch</td><td class="field_body">$rec[5]</td></tr>
...
$ii++;
		...
		echo <<<s
				...
				<table width=100% class="record_table">
					<tr><th colspan=3 class="record_head">Record No : $ii</th></tr>
					<tr><td width=10%>&nbsp;</td><td width=20% class="field_head">Batch</td><td class="field_body">$rec1[5]</td></tr>
